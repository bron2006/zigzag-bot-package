...
def _execute_requests(user_id, requests):
    ...
    try:
        ...
        for request in requests:
            ...
            request_result = {"data": None, "error": None}

            def on_success(response_message):
                request_result["data"] = response_message
                response_received.set()

            def on_error(error_message):
                request_result["error"] = error_message
                response_received.set()
            ...
            response_message = request_result["data"]
