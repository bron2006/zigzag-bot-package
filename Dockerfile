...
# Оновлюємо систему та встановлюємо необхідні інструменти (включно з git для pip)
...
# Агресивне очищення перед установкою (про всяк випадок)
