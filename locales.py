...
REASON_REPLACEMENTS = {
    "en": [
        ...
        ("Вхід заблоковано: таймфрейми не підтвердили один напрямок", "Entry blocked: timeframes did not confirm one direction"),
        ("Ціна вже пішла проти купівлі", "Price has already moved against buy"),
        ("Ціна вже пішла проти продажу", "Price has already moved against sell"),
        ("нижче ціни сигналу", "below signal price"),
        ("вище ціни сигналу", "above signal price"),
    ...
    "uk": [
        ...
        ("Entry blocked: timeframes did not confirm one direction", "Вхід заблоковано: таймфрейми не підтвердили один напрямок"),
        ("Price has already moved against buy", "Ціна вже пішла проти купівлі"),
        ("Price has already moved against sell", "Ціна вже пішла проти продажу"),
        ("below signal price", "нижче ціни сигналу"),
        ("above signal price", "вище ціни сигналу"),
